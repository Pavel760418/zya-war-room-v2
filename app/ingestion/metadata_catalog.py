...
WAR_ROOM_LOGICAL_ALIASES: dict[str, tuple[str, ...]] = {
    ...
    "Справочник.Склады": ("Справочник.СкладыКомпании", "Справочник.Склады", "Reference76"),
    ...
    # Розничные чеки: ЗакрытиеСмены (не Document156=ПоступлениеТоваров)
    "Документ.ЗакрытиеСмены": ("Документ.ЗакрытиеСмены", "Document119"),
    "Документ.ЗакрытиеСмены.СнятыеКассы": ("Document119.VT2313", "Документ.ЗакрытиеСмены.СнятыеКассы"),
    "Справочник.СтатьиДоходовИРасходов": ("Справочник.СтатьиДоходовИРасходов", "Reference82"),
    "Документ.КассовыйЧек": ("Document119",),  # legacy alias → shift close
    "Документ.КассовыйЧек.Товары": ("Document119.VT2313",),
...
def known_war_room_physicals() -> dict[str, str]:
    ...
    fallbacks = {
        ...
        "Справочник.Склады": "_Reference76",
        "РегистрСведений.ЗначенияСвойствОбъектов": "_InfoRg5758",
        "ПланВидовХарактеристик.СвойстваОбъектов": "_Chrc339",
        "Документ.КассовыйЧек": "_Document119",
        "Документ.КассовыйЧек.Товары": "_Document119_VT2313",
        "Документ.ЗакрытиеСмены": "_Document119",
        "Документ.ЗакрытиеСмены.СнятыеКассы": "_Document119_VT2313",
        "Справочник.СтатьиДоходовИРасходов": "_Reference82",
    }
